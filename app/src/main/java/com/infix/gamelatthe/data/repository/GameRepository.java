...
public class GameRepository {
    ...
    public void endRoomOnline(String roomId, String status, String winnerId, RoomOnlineListener listener) {
        remoteDataSource.endRoomOnline(roomId, status, winnerId, listener);
    }
    ...
    public void updateMatchHistory(RoomOnline roomOnline, RoomOnlineListener listener) {
